    ...
    <>
      <div className="bg-white-A700 flex flex-col font-montserrat items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="bg-gray-50 flex flex-col items-center justify-end py-[33px] w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-10 gap-20 items-start justify-start mt-[42px] md:px-10 px-20 sm:px-5 w-auto md:w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start max-w-[1279px] w-full">
                ...
                <div className="overflow-x-auto w-full">
                  <div className="flex flex-col items-start justify-start w-full">
                    ...
                    <div className="flex sm:flex-col flex-row md:gap-10 items-center justify-between overflow-auto w-full">
                      <Input
                        name="frameSixty"
                        placeholder="Specialist Consultation (Pediatrician, Gynecologists&#39;, Ophthalmology, Cardiology, etc...)"
                    ...
                    <div className="border-blue_gray-100 border-solid border-t flex flex-col items-start justify-start py-3 w-full">
                      ...
                      >
                        ...
                        <span className="text-gray-700 font-montserrat text-left font-normal">
                          Laboratory Test required by doctor(Biopsy, Histology,
                          etc...)
                        </span>
                      </Text>
                    </div>
                    ...
                    <div className="border-blue_gray-100 border-solid border-t flex flex-col gap-2.5 items-start justify-start py-3 w-full">
                      <Text
                        ...
                        size="txtMontserratSemiBold15Bluegray90001"
                      >
                        Optical - Optometry, frames and lenses (Every 2years)
                      </Text>
                      <div className="flex flex-col items-center justify-center sm:pl-5 pl-8 pr-3 w-full">
                        <Text
                          className="leading-[20.00px] max-w-[869px] md:max-w-full text-[15px] text-gray-700"
              ...
              <div className="flex flex-col items-start justify-start w-[366px]">
                ...
                <div className="border-blue_gray-100 border-solid border-t flex flex-col h-[134px] md:h-auto items-center justify-center px-2 py-3 w-full">
                  <Img
                    className="h-5 w-5"
                    src="images/img_checkmark_indigo_800.svg"
                    alt="checkmark_Four"
                ...
                <Button
                  className="cursor-pointer h-[94px] text-[15px] text-center w-full"
                  shape="square"
                  color="blue_gray_100"
                  size="xl"
                  variant="outline"
                ...
                <div className="border-blue_gray-100 border-solid border-t flex flex-col h-[148px] md:h-auto items-center justify-center px-2 py-3 w-full">
                  <Text
                    className="text-[15px] text-center text-indigo-800 w-auto"
                ...
                <div className="border-blue_gray-100 border-solid border-t flex flex-col h-[154px] md:h-auto items-center justify-center px-2 py-3 w-full">
                  <Text
                    className="text-[15px] text-center text-indigo-800 w-auto"
                    size="txtMontserratRegular15Indigo800"
                  >
                ...
                <Button
                  className="cursor-pointer h-[63px] text-[15px] text-center w-full"
                  shape="square"
                  color="blue_gray_100"
                  size="md"
                  variant="outline"
                ...
                <div className="border-blue_gray-100 border-solid border-t flex flex-col items-start justify-start py-3 w-full">
                  ...
                  >
                    <>
                      Imaging <br /> X-ray, <br />
                      USG Scan, <br />
                      CT Scan, (No limit on body parts)
                      <br />
                      MRI (No limit on body parts)
                    </>
                  </Text>
                </div>
                <Text
