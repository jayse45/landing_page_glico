  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-montserrat items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="bg-gray-50 flex flex-col gap-[38px] items-center justify-start md:pr-10 sm:pr-5 pr-[58px] py-[58px] w-full">
          <Text
          ...
          <div className="flex md:flex-col flex-row md:gap-10 gap-20 items-start justify-start mb-6 md:px-10 px-20 sm:px-5 w-auto md:w-full">
