  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-montserrat items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="bg-gray-50 flex flex-col gap-[52px] items-center justify-end md:pr-10 sm:pr-5 pr-[54px] py-[54px] w-full">
          <Text
...
export default Under60EightPage;
