    ...
    <>
      <div className="bg-white-A700 flex flex-col font-montserrat items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="bg-white-A700 flex flex-col items-center justify-start w-full">
          <div className="h-[481px] md:px-5 relative w-full">
            <Img
        ...
        <div className="bg-indigo-800 h-[518px] sm:h-[913px] sm:p-[] pl-[78px] md:px-5 relative w-full">
          ...
          <div className="absolute flex flex-col gap-6 sm:gap-6 inset-x-[0] items-center justify-start max-w-[846px] mx-auto sm:relative top-[13%] w-full">
            <Text
          ...
          <List
            className="absolute bottom-[13%] sm:bottom-[] sm:flex-col flex-row gap-[11px] grid md:grid-cols-2 grid-cols-4 h-[198px] inset-x-[0] justify-start max-w-[1284px] mx-auto sm:relative sm:top-[174px] w-full"
        ...
        <div
          className="common-pointer bg-white-A700 flex flex-col items-center justify-start p-[67px] md:px-10 sm:px-5 w-full"
          id="block1"
          onClick={() => {
        ...
        >
          <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between max-w-[1292px] mb-[3px] mt-[19px] mx-auto w-full">
            ...
            <div className="md:h-[534px] h-[589px] relative w-[48%] md:w-full">
              <Img
