  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-montserrat items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="bg-gray-50 flex flex-col gap-[52px] items-center justify-end md:pr-10 sm:pr-5 pr-[55px] py-[55px] w-full">
          <Text
            className="mt-[3px] md:text-3xl sm:text-[28px] text-[32px] text-center text-indigo-800 tracking-[-1.00px]"
            size="txtMontserratBold32"
          >
            Benefits
          </Text>
          <List
            className="sm:flex-col flex-row md:gap-10 gap-[70px] grid md:grid-cols-2 grid-cols-3 justify-start w-auto md:w-full"
            orientation="horizontal"
          >
          ...
          <div className="flex md:flex-col flex-row md:gap-10 gap-20 items-start justify-start md:px-10 px-20 sm:px-5 w-auto md:w-full">
